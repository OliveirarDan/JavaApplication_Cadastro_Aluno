package com.senai.CadastraAlunos.configuration;
...
@EnableJpaRepositories(basePackages = "com.senai.CadastraAlunos.dao")
public class PersistenceConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.senai.CadastraAlunos.entity");
